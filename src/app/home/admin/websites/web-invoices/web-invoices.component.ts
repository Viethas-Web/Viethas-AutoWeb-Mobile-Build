...
@Component({
  selector: 'app-web-invoices',
  templateUrl: './web-invoices.component.html',
  styleUrls: ['./web-invoices.component.scss']
})
export class WebInvoicesComponent implements OnInit {
