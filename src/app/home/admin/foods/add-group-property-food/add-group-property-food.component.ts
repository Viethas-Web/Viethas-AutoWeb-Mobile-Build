...
@Component({
  selector: 'app-add-group-property-food',
  templateUrl: './add-group-property-food.component.html',
  styleUrls: ['./add-group-property-food.component.scss']
})
export class AddGroupPropertyFoodComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<AddGroupPropertyFoodComponent>,
