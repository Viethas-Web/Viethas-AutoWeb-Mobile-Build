...
export class DetailInvoiceOnlineComponent implements OnInit {
  showDetail: any;
    ...
    constructor(
      ...
      public dialogRef: MatDialogRef<DetailInvoiceOnlineComponent>,
    ...
    completeInvoice() {
      ...
      this.vhQueryAutoWeb.updateBill(this.data._id,{
        confirmed: true
      }) 
      .then(()=>{
