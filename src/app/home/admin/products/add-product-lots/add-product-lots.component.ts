...
@Component({
  selector: 'app-add-product-lots',
  templateUrl: './add-product-lots.component.html',
  styleUrls: ['./add-product-lots.component.scss']
})
export class AddProductLotsComponent implements OnInit {
  
  constructor(
    private vhQueryAutoWeb: VhQueryAutoWeb,
    public dialogRef: MatDialogRef<AddProductLotsComponent>,
