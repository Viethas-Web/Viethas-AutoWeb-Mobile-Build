...
@Component({
  selector: 'app-hosting-config',
  templateUrl: './hosting-config.component.html',
  styleUrls: ['./hosting-config.component.scss']
})
export class HostingConfigComponent implements OnInit {
